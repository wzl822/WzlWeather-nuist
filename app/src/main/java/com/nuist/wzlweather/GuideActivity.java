...
import com.nuist.wzlweather.ChooseAreaFragment;
...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<pageViews.size();i++){
            ...
            if(i==0){
                imageViews[i].setBackgroundResource(R.drawable.shape_dot_red);
            }else{
                imageViews[i].setBackgroundResource(R.drawable.shape_dot_gray);
            }
    ...
    class GuidePageChangeListener implements OnPageChangeListener{
        ...
        public void onPageSelected(int position) {
            ...
            for(int i=0;i<imageViews.length;i++){
                imageViews[position].setBackgroundResource(R.drawable.shape_dot_red);
